...
<div class="w100" style="margin-bottom: 10px;">
  ...
  <div class="well">
    ...
    <div id="new-images">
      ...
      <p><a class="btn js_refresh" href="<?php echo site_url("gallery/album/images/$album->id"); ?>" style="margin: 10px 0;"><i class="icon-refresh"></i> Refresh</a></p>
  ...
  <ul id="sortable">
    ...
    <li id="image_<?php echo $image->id; ?>" class="ui-state-default" style="height: <?php echo $config->thumb_height + 10; ?>px">
      ...
      <div class="btn-group">
        ...
        <a href="<?php echo site_url("gallery/image/ajax_edit/$album->id/$image->id"); ?>" class="btn js_edit_image" title="Edit" rel="tooltip" data-original-title="Edit"><i class="icon-pencil"></i></a>
        ...
        <a href="<?php echo site_url("gallery/image/unpublish/$album->id/$image->id"); ?>" class="btn btn-success js_publish" title="Published" rel="tooltip" data-original-title="Published"><i class="icon-ok icon-white"></i></a>
        <?php else: ?>
        <a href="<?php echo site_url("gallery/image/publish/$album->id/$image->id"); ?>" class="btn js_publish" title="Unpublished" rel="tooltip" data-original-title="Unpublished"><i class="icon-ok"></i></a>
        <?php endif; ?>
...
$(document).ready(function() {
    ...
    $('.js_edit_image').click(function(e) {
        e.preventDefault();
        var url = $(this).attr('href');
        var thisFancyboxEdit = thisFancybox;
        thisFancyboxEdit.href = $('.js_edit_image').attr('href');
        thisFancyboxEdit.width = '100%';
        $.fancybox(thisFancybox);
    });
  ...
  $('#image-modal-delete-btn').click(function(e){
      e.preventDefault();
