...
<ul class="pager">
  <li class="previous">
    <a href="<?php echo site_url('gallery/feed'); ?>">&larr; Back to feeds</a>
  </li>
</ul>
...
<span>JSON feed</span>
<pre><a href="<?php echo site_url("gallery/api/myfeed/json/$feed->uuid"); ?>" target="_blank"><?php echo site_url("gallery/api/myfeed/json/$feed->uuid"); ?></a></pre>
<span>XML feed</span>
<pre><a href="<?php echo site_url("gallery/api/myfeed/xml/$feed->uuid"); ?>" target="_blank"><?php echo site_url("gallery/api/myfeed/xml/$feed->uuid"); ?></a></pre>
...
$(document).ready(function() {
  ...
  $('#feeds').sortable({
    ...
    update : function () {
      ...
      $.ajax({
        url          : '<?php echo base_url(); ?>gallery/feed/reorder/<?php echo $feed->id; ?>?' + order,
        type         : 'GET',
        cache        : false,
