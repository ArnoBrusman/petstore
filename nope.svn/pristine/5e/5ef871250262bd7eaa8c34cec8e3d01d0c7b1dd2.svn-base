  ...
  <thead>
    <tr>
      ...
      <th>
        ...
        <a class="btn btn-primary" href="<?php echo site_url("gallery/user/create"); ?>">Create new user</a>
        <?php endif; ?>
      </th>
    </tr>
  </thead>
      ...
      <td>
        <div class="btn-group">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?php echo site_url("gallery/user/edit/$user->id"); ?>"><i class="icon-pencil"></i> Edit</a></li>
            <?php if ($user_data['is_admin'] == 1): ?>
            <li><a href="<?php echo site_url("gallery/user/deactivate/$user->id"); ?>"><i class="icon-ban-circle"></i> Deactivate</a></li>
            <li><a class="user-delete-btn" href="#user-modal" data-toggle="modal" rel="<?php echo site_url("gallery/user/remove/$user->id"); ?>">
